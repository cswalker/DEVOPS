...
pipeline {
    ...
    parameters {
        ...
        string(name: 'backend_set_name', defaultValue: '', description: 'The name of the backend set to remove')
    }
    ...
    stages {
        ...
        stage('Remove App Load Balancer Backend Set') {
            steps {
                script {
                        ...
                        "${ENV_TYPE}": [
                            hosts: [
                                localhost: [
                                    ...
                                    backend_set_name: params.backend_set_name,
                                ]
                            ]
                        ]
                    ]
                    ...
                    sh """
                        ansible-playbook -i inventory.yaml \
                            provisioners/loadbalancer/ansible/app-backendset-remove.yaml
                    """
                }
            }
        }
