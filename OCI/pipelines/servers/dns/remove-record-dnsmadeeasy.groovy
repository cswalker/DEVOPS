pipeline {
    ...
    parameters {
        ...
        choice(name: 'record_type', choices: ['A', 'CNAME'], description: 'Provide the type for this record')
    }
    stages {
        stage('Init') {
            steps {
                ...
                script {
                    ...
                    sh """
                        ansible-playbook -i inventory.yaml \
                            ...
                            provisioners/dns/ansible/remove-dns-dnsmadeeasy.yaml
                    """
                }
            }
        }
