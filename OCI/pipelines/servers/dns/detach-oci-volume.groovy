        ...
        stage('Detach DNS Volume') {
            steps {
                script {
                    ...
                    ${params.env_type}_${params.instance_role} ansible_host=${server_info.instance.private_ip} ansible_python_interpreter=/usr/bin/python3"""
                    ...
                    sh """
                        ansible-playbook -i inventory.yaml \
                            ...
                            provisioners/dns/ansible/detach-oci-volume.yaml
                    """
                }
            }
        }
