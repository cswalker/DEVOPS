pipeline {
    ...
    parameters {
        ...
        string(name: 'instance_shape', defaultValue: 'VM.Standard.E2.4', description: 'Compute shape the instance will be built on')
    }
    stages {
        stage('Init') {
            steps {
                ...
                script {
                    ...
                    sh """
                        ansible-playbook -i inventory.yaml \
                            ...
                            provisioners/static/ansible/create-oci-instance.yaml
                    """
                }
            }
        }
