pipeline {
    ...
    stages {
        ...
        stage('Reconfigure Connection to Demoted Domain Controller') {
            steps {
                script {
                    ...
                    demoted-controller ansible_host=${server_info.instance.private_ip} ansible_python_interpreter=/usr/bin/python3"""
                    ...
                    sh """
                        ansible-playbook -i inventory.yaml \
                            ...
                            provisioners/domain-controller/ansible/reconstruct-controller.yaml
                    """
                }
            }
        }
