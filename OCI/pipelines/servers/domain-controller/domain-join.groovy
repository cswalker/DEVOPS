pipeline {
    ...
    stages {
        ...
        stage('Configuring Domain Controller Server') {
            steps {
                script {
                    ...
                    windows ansible_host=${server_info.instance.private_ip} ansible_python_interpreter=/usr/bin/python3"""
                    ...
                    sh """
                        ansible-playbook -i inventory.yaml \
                            ...
                            provisioners/domain-controller/ansible/domain-join.yaml
                    """
                }
            }
        }
