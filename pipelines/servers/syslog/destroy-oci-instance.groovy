pipeline {
    ...
    parameters {
        ...
        string(name: 'env_name', defaultValue: 'syslog', description: 'Provide the environment name to be destroyed')
                ...
                script {
                    sh """
                        ansible-playbook \
                            ...
                            provisioners/syslog/ansible/destroy-oci-instance.yaml
                    """
                }
            }
        }
