pipeline {
    ...
    parameters {
        ...
        string(name: 'server_name', defaultValue: 'checkmk', description: 'Provide a URL safe unique name for this server')
                ...
                script {
                    ...
                    sh """
                        ansible-playbook -i inventory.yaml \
                            ...
                            provisioners/checkmk/ansible/create-oci-instance.yaml
                    """
                }
            }
        }
